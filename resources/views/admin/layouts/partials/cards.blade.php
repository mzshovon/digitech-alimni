            ...
            <div class="col-xxl-4 col-md-6">
              ...
              <div class="col-xxl-4 col-xl-12">
                ...
                <div class="card info-card customers-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Payments <span>| This Year</span></h5>
              ...
              <div class="col-xxl-4 col-xl-12">
                ...
                <div class="card info-card customers-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Support Tickets <span>| This Year</span></h5>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        <h6>{{$contactCount}}</h6>
                        <span class="text-success small pt-1 fw-bold">1%</span> <span class="text-muted small pt-2 ps-1">increase</span>
                        {{-- <span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">decrease</span> --}}
